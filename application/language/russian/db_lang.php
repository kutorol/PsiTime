...
$lang['db_unable_to_select']			= 'Невозможно выбрать указанную базу данных: %s. Если вы "почти" первый раз запустили сайт, то удалите файл /application/migrations/install.log';
